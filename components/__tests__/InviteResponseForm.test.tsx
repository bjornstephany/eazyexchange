...
describe('InviteResponseForm (parent-facing, French)', () => {
  ...
  it('renders the parent-facing heading and confirm CTA', () => {
    render(<InviteResponseForm token="t" studentName="Léa Martin" exchangeName="Espagne · Automne 2026" preselect={null} />)
  ...
  it('confirms Yes inline (no navigation) with the setup-link copy', async () => {
    ...
    render(<InviteResponseForm token="t" studentName="Léa" exchangeName="X" preselect={null} />)
  ...
  it('confirms a No inline', async () => {
    const user = userEvent.setup()
    render(<InviteResponseForm token="t" studentName="" exchangeName="X" preselect={null} />)
  ...
  it('preselect=maybe reveals the questions textarea immediately', () => {
    render(<InviteResponseForm token="t" studentName="Léa" exchangeName="X" preselect="maybe" />)
